...
public class slip20BlinkingImage implements Runnable {
    private JLabel label;

    public slip20BlinkingImage(JLabel label) {
        this.label = label;
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            slip20BlinkingImage blinkingImage = new slip20BlinkingImage(imageLabel);
