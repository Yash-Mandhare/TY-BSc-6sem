...
public class slip1EmployeeDetailsForm extends JFrame implements ActionListener {
    ...
    public slip1EmployeeDetailsForm() {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == submitButton) {
            ...
            try {
                Connection conn = DriverManager.getConnection("jdbc:postgresql://localhost:5432/postgres", "postgres", "6512");
