...
public class slip12DisplayProjectDetails extends JFrame {
    private JTable table;

    public slip12DisplayProjectDetails() {
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:postgresql://localhost:5432/postgres", "postgres", "6512")) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            slip12DisplayProjectDetails frame = new slip12DisplayProjectDetails();
